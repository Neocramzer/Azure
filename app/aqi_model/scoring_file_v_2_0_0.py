...
data_sample = PandasParameterType(pd.DataFrame({"co": pd.Series([0.0], dtype="float64"), "no": pd.Series([0.0], dtype="float32"), "no2": pd.Series([0.0], dtype="float32"), "o3": pd.Series([0.0], dtype="float32"), "so2": pd.Series([0.0], dtype="float32"), "pm2_5": pd.Series([0.0], dtype="float32"), "pm10": pd.Series([0.0], dtype="float32"), "nh3": pd.Series([0.0], dtype="float32")}))
